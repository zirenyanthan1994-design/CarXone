...
export default function PartnersDashboard() {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      if (settingsSnap.exists()) {
        ...
        setWhatsappNumber(data.whatsappNumber || ""); // NEW: Load WhatsApp Number
      }
    } catch (error) {
  ...
  const handleSaveSettings = async (e: React.FormEvent) => { 
    ...
    try { 
      await setDoc(doc(db, "vendorSettings", "Dimapur Rentals"), { 
        ...
        whatsappNumber: whatsappNumber, // NEW: Save WhatsApp Number
  ...
  const handleConfirmBooking = async () => {
    ...
    try {
      ...
      // --- TRIGGER AUTOMATED WHATSAPP TO CUSTOMER ---
      try {
        await fetch('/api/whatsapp', {
          ...
          body: JSON.stringify({
            ...
            customerPhone: "911234567890", // Placeholder until phone fields are captured
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="p-8">
              ...
              <form onSubmit={handleSaveSettings} className="space-y-8 max-w-3xl">
                ...
                {/* --- UPGRADED: WHATSAPP NUMBER FIELD --- */}
                <div className="bg-green-50 border border-green-200 p-6 rounded-lg shadow-sm">
                  ...
                  <input type="tel" required value={whatsappNumber} onChange={(e) => setWhatsappNumber(e.target.value)} placeholder="+91" className="w-full border-2 border-white rounded-lg p-4 focus:border-green-600 outline-none text-sm font-bold text-black shadow-sm" />
                </div>
                ...
                <div className="bg-gray-50 border border-gray-200 p-6 rounded-lg shadow-sm">
                  ...
                  <p className="text-xs text-gray-500 mb-4 font-medium">Are you willing to give the platform a commission for bringing you confirmed bookings? Enter the percentage here. This is automatically deducted from your ledger.</p>
                  <div className="relative w-full md:w-1/3">
                    <input type="number" min="0" max="100" value={commissionRate} onChange={(e) => setCommissionRate(Number(e.target.value))} placeholder="e.g. 5" className="w-full border-2 border-white rounded-lg p-4 pl-12 focus:border-gray-400 outline-none text-lg font-black text-gray-800 shadow-sm" />
                    <span className="absolute left-4 top-1/2 transform -translate-y-1/2 font-black text-gray-400 text-lg">%</span>
                  </div>
                </div>
