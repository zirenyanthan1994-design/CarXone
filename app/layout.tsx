          ...
          <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200/50 shadow-sm transition-all duration-300">
            <div className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto">
              ...
              <div className="relative group">
                <button className="flex items-center justify-center p-2 text-black hover:text-green-600 transition duration-300 cursor-pointer">
                ...
                <div className="absolute right-0 top-full pt-4 w-64 hidden group-hover:block z-50 transition-opacity duration-300">
                  <div className="bg-white border border-gray-100 shadow-2xl rounded-xl flex flex-col text-left overflow-hidden">
                    ...
                    <a href="/profile" className="px-6 py-3 text-sm font-bold text-black hover:bg-green-50 hover:text-green-700 transition">My Profile</a>
